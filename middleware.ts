...
export async function middleware(request: NextRequest) { // Consider making async if getSessionCookie is async
  ...
  if (!isPublicPath && !session) { // Check if session is falsy (null, undefined, etc.)
