...
export default function NotificationsPage() {
  ...
  if (status) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-zinc-950 text-white">
        <Bell className="mr-2 h-6 w-6 animate-spin text-zinc-400" />
  ...
  if (session?.user) {
    return (
      <div className="min-h-[88vh] bg-zinc-950 p-8 text-white">
        {/* Empty State / Content */}
        <div className="flex h-[70vh] flex-col items-center justify-center text-zinc-400">
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 text-white">
      <p className="text-red-400 text-xl">Redirecting to login...</p>
    </div>
  );
}
