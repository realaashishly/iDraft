...
export default function DigitalClock() {
    ...
    const formattedDate = new Intl.DateTimeFormat('en-US', dateOptions).format(currentTime).toUpperCase();
        ...
        <div className="flex flex-col items-center justify-center w-full h-full p-4"> 
            ...
            <div className="relative z-10 w-full">
                ...
                <div className="flex items-baseline justify-center font-mono text-zinc-200 ">
                    ...
                    <span className={`text-5xl sm:text-6xl **lg:text-7xl** font-light mx-1 sm:mx-2 text-zinc-400 transition-opacity duration-500 ${isEvenSecond ? 'opacity-100' : 'opacity-40'}`}>
                        :
                    </span>
