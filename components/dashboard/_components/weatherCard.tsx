...
const WeatherWidget: FC = () => {
    ...
    useEffect(() => {
        ...
        navigator.geolocation.getCurrentPosition(
            ...
            (err) => {
                console.error(
                    "WeatherWidget: ⛔️ Geolocation failed:",
                    err.message
                );
                setError(
    ...
    const fetchWeatherData = async (lat: number, lon: number, key: string) => {
        try {
            ...
            if (!Array.isArray(weatherArr) || weatherArr.length === 0) {
                throw new Error(
                    "Unexpected weather data format (no weather array)."
                );
            }
            ...
            console.error(
                "WeatherWidget: ⛔️ Error fetching weather data:",
                err
            );
        ...
        <div className='w-full flex flex-col space-y-2'>
            <div className='flex justify-between items-center'>
                <div className='flex items-center gap-2'>
                    <MainIcon size={28} className='text-foreground' />
            ...
            <div className='flex justify-between w-full border-t border-border/50 pt-2'>
                {forecast.map((item, idx) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <FI size={16} className='text-foreground' />
